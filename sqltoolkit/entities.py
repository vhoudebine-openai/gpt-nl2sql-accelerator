...
class TableColumn(BaseModel):  
    ...
    def get_llm_definition(self, table_json, openai_client, model, extra_context) -> str:
...
class Table(BaseModel):  
    ...
    def get_table_description(self, openai_client, model, extra_context) -> str:  
    ...
    def get_table_readable_name(self, openai_client, model, extra_context) -> str:
    ...
    def extract_llm_column_definitions(self, openai_client, model, extra_context) -> None:
        """Extracts AI generated definitions for each column in the table."""
        table_json = self.json(exclude=['db_client'])
        for column in self.columns:
            column.get_llm_definition(table_json, openai_client, model, extra_context)
